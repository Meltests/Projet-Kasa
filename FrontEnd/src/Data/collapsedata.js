const textecollapse = [
   {
      title: 'Fiabilité',
      description:
         'Les annonces postées sur Kasa grandissent une fiabilité totale. Les photos sont conformes aux logements, et toutes les informations sont régulièrement vérifiées par nos équipes.',
   },
   {
      title: 'Respect',
      description:
